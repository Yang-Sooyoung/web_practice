...
public class Java100_oop_Polymorphism7 {
	public static void main(String[] args) {
		...
		Person13[] persons = new Person13[10];		//--- 이건 Person13 전용 --;;
		persons[0] = new Person13();
		persons[1] = new Person13();
		persons[2] = new Batman();
		
		Batman[] batmans = new Batman[10];	//--- 이건 Batman 전용 --;;
		batmans[0] = new Batman();
		batmans[1] = new Batman();
		// batmans[2] = new Person13();			//--- Err
		...
		System.out.println( new Person13() );
